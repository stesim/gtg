...
function intersectionPolygons(polygon1, polygon2) {
    ...
    for (var i = 0; i < polygon1.length; i++) {
        ...
        polygon1ExpandedDict[i] = [cloneVector(polygon1[i])];
        for (var j = 0; j < polygon2.length; j++) {
            if (i == 0)
                polygon2ExpandedDict[j] = [cloneVector(polygon2[j])];
            ...
            if (intersectionResult.onLine1 && intersectionResult.onLine2) {
                if (pointsEqual(intersectionResult, polygon1[i])) {
                    ...
                    var newPolygon1Point = cloneIntersection(intersectionResult);
                ...
                if (pointsEqual(intersectionResult, polygon2[j])) {
                    ...
                    var newPolygon2Point = cloneIntersection(intersectionResult);
...
function cloneIntersection(object) {
    return { x: object.x, y: object.y, onLine1: object.onLine1, onLine2: object.onLine2 };
}
